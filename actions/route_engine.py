...
def compute_routes(o: tuple, d: tuple, o_label: str, d_label: str,
    ...
    """Compute alternative routes (OSRM) and cache them. Returns the route list.

    Each route: {distance_m, duration_s, turns, summary, points,
                 analysis, dist_km, eta_text}.
    ...
    for r in routes:
        ...
        r["eta_text"] = _fmt_dur(r["duration_s"])
