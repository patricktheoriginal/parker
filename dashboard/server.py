"""
dashboard/server.py — Parker Local HTTP Dashboard
...
def _make_uploads_dir() -> Path:
    ...
    for candidate in [
        Path.home() / "Downloads" / "Parker Uploads",
        Path.home() / "Documents" / "Parker Uploads",
        BASE_DIR / "uploads",
    ]:
        try:
    ...
    if sys.platform == "win32":
        ...
        try:
            ...
            if int(ret) > 32:
                ...
                print("[Dashboard] Phone connections may fail until Parker is run as Administrator.")
...
<p>Press <strong style="color:#dde3ed">Remote Control</strong> in Parker to get a new QR code.</p>
</div></body></html>""")
...
<p>Connecting to Parker…</p>
    ...
    async def serve(self) -> None:
        ...
        print("[Dashboard] Press 'Remote Control' in Parker UI to get the QR code.")
        await uvicorn.Server(cfg).serve()
